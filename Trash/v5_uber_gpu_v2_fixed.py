# ================================================================================
# quant_meta_hybrid_trader_v5_UBER_FIXED_v2.py
#
# 全部乗せ研究用トレーダーフレームワーク v5 - UBER最強版（GPU全力版・修正版v2）
# Mixed Precision対応（Float16/Float32型ミスマッチ解決）
...
print(f"\n{'='*80}")
print(f"🚀 Quant Meta Hybrid Trader v5 - UBER GPU Edition (v2 - Mixed Precision対応)")
print(f"{'='*80}")
...
class WaveAttentionBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        wave = wave.unsqueeze(0).unsqueeze(2)  # (1, H, 1, L)
